...
$base_url="http://tycelikinsaat.com.tr/insaat/";  // base url of site. If you prefer relative urls leave empty
$upload_dir = '/uploads/'; // path from base_url to base of upload folder
$current_path = '../../../../../../uploads/'; // relative path from filemanager folder to upload folder
